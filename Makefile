...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/spockproxy.spec.in $(top_srcdir)/configure AUTHORS \
...
CONFIG_CLEAN_FILES = spockproxy.spec
...
top_srcdir = .
SUBDIRS = src
EXTRA_DIST = spockproxy.spec COPYING.lfs CMakeLists.txt README.TESTS
...
spockproxy.spec: $(top_builddir)/config.status $(srcdir)/spockproxy.spec.in
